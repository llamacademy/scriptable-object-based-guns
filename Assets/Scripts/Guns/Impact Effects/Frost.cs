...
namespace LlamAcademy.Guns.ImpactEffects
{
    public class Frost : AbstractAreaOfEffect
    {
        ...
        public Frost(float Radius, AnimationCurve DamageFalloff, float BaseDamage, int MaxEnemiesAffected) : base(Radius, DamageFalloff, BaseDamage, MaxEnemiesAffected)
        {
        }

        public Frost(float Radius, AnimationCurve DamageFalloff, float BaseDamage, int MaxEnemiesAffected, AnimationCurve SlowDecay) : base(Radius, DamageFalloff, BaseDamage, MaxEnemiesAffected)
        {
