...
namespace LlamAcademy.Guns.Demo.UI
{
    ...
    public class AttachmentDocument : MonoBehaviour
    {
            ...
            { Slot.Handle, new List<Attachment>()
                {
                    ...
                    {
                        new Vector3Modifier(new Vector3(0, 0.9f, 0), "ShootConfig/Spread"),
        ...
        private void Start()
        {
            ...
            slot.Button.RegisterCallback<ClickEvent>((_) => HandleSlotClick(Slot.Barrel, slot));
            SlotScrollView.Add(slot);

            AttachmentSlot slot2 = new("Handle", "Standard issue", "ban");
            slot2.Button.RegisterCallback<ClickEvent>((_) => HandleSlotClick(Slot.Handle, slot2));
            SlotScrollView.Add(slot2);

            AttachmentSlot slot3 = new("Ammo Type", "Standard issue", "ban");
            slot3.Button.RegisterCallback<ClickEvent>((_) => HandleSlotClick(Slot.Ammo, slot3));
        ...
        private IEnumerator BuildOptionsForSlot(Slot FocusSlot)
        {
            ...
            optionContainer.AddToClassList("fade-in-left");
        ...
        private void HideOptionContainer(VisualElement OptionContainer)
        {
            ...
            OptionContainer.RemoveFromClassList("fade-in-left");
